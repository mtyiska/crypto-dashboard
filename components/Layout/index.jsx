    ...
    <div className="flex">
        ...
        <div className="flex flex-col min-h-screen h-screen">
            ...
            <div className="flex text-white h-12">
                <div className="bg-gray-800 w-56 flex-none flex items-center justify-between py-2 px-3 border-b border-gray-900">
                    TailWind Css
                    <button>
                        <ChevDown/>
                    </button>
                </div>
                <div className="flex flex-1 items-center justify-between bg-gray-750 px-4 border-b border-gray-900">
